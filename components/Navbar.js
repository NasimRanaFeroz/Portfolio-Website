...
const Navbar = () => {
  ...
  return (
    <div
      className="navbar bg-gradient-to-r from-[#0b1320] to-[#162032] text-blue-50
      border-b border-sky-900/40 px-4 sm:px-10 lg:px-20 z-50 sticky top-0
    ...
    >
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <motion.ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-gradient-to-b from-[#0b1320]/95 to-[#162032]/95
              backdrop-blur-md rounded-box z-[1] mt-3 w-52 p-2 shadow-lg shadow-sky-900/20 border border-sky-900/30"
            initial="closed"
        ...
        <div className="hidden sm:block">
          <motion.p
            className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r
              from-sky-400 to-blue-500 md:pl-3 sm:pl-2"
