...
const inputHoverTransition = { type: "spring", stiffness: 300, damping: 20 };
...
const Contact = () => {
  ...
  const handleSubmit = useCallback(
    (event) => {
      ...
      if (!email || !message) {
        ...
        setTimeout(() => setError(""), CLEAR_DELAY);
        return;
      }
      ...
      emailjs
        ...
        .then(
          () => {
            ...
            setEmail("");
            setMessage("");
            setTimeout(() => setSuccess(""), CLEAR_DELAY);
          },
          (err) => {
            setIsLoading(false);
            setError(
              "Message sending failed. Please try again or email me directly.",
            );
            console.error(err);
            setTimeout(() => setError(""), CLEAR_DELAY);
          },
  ...
  const getFocusClass = (field) =>
    focusedField === field ? "ring-2 ring-sky-400" : "";
      ...
      >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-5">
            ...
            >
              <div>
                <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-blue-500 mb-6">
                  Let&apos;s Connect
                </h2>
                ...
                <div className="mb-8">
                  <p className="text-sky-400 font-medium mb-2">Email me at</p>
                  <motion.a
                    href="mailto:feroznasimrana@gmail.com"
                    className="text-blue-50 hover:text-sky-400 transition-colors duration-300 flex items-center gap-2 mb-2"
                    whileHover={{ x: 5 }}
                  >
                  ...
                  <motion.a
                    href="mailto:nasimranaferoz@qq.com"
                    className="text-blue-50 hover:text-sky-400 transition-colors duration-300 flex items-center gap-2"
                    whileHover={{ x: 5 }}
                  >
                    <MdEmail className="inline-block" />
                    nasimranaferoz@qq.com
                  </motion.a>
                </div>
              </div>

              <div>
                <p className="text-sky-400 font-medium mb-4">Connect with me</p>
            ...
            <motion.div className="lg:col-span-3 p-8" variants={itemVariants}>
              ...
              >
                <motion.div variants={itemVariants}>
                  ...
                  <motion.div
                    className={`relative rounded-lg overflow-hidden ${getFocusClass("name")}`}
                    whileHover={inputHover}
                    transition={inputHoverTransition}
                  >
                    <input
                      id="name"
                      name="name"
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <motion.div
                    className={`relative rounded-lg overflow-hidden ${getFocusClass("email")}`}
                    whileHover={inputHover}
                    transition={inputHoverTransition}
                  >
                    <input
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <motion.div
                    className={`relative rounded-lg overflow-hidden ${getFocusClass("message")}`}
                    whileHover={inputHover}
                    transition={inputHoverTransition}
                  >
                    <textarea
