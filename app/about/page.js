...
const journeyItemVariants = (index) => ({
  ...
  return (
    <div className="bg-gradient-to-b from-[#0f172a] to-[#1B263B] min-h-screen text-white">
      ...
      <div className="relative h-[40vh] overflow-hidden flex items-center justify-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-blue-500">
            About Me
          </h1>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <motion.div className="lg:w-3/5" variants={slideRight}>
            <motion.h2
            ...
            <motion.p
              ...
              variants={fadeUp(0.2)}
            >
              A 4th-year Software Engineering student at Sichuan University with
              a focus on building impactful web applications.
            </motion.p>
            ...
            >
              ...
              creating responsive and user-friendly interfaces. My goal is to
            ...
            <motion.div variants={fadeUp(0.6)}>
              <Link
                href="/projects"
                className="px-6 py-2 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full text-white font-medium hover:from-sky-600 hover:to-blue-700 transition-all duration-300 inline-flex items-center group"
              >
                View My Work
                <ArrowIcon />
              </Link>
        ...
        >
          ...
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-1/2 h-full w-1 bg-gradient-to-b from-sky-500 to-blue-600" />
            ...
            {journey.map((item, index) => (
              <motion.div
                ...
                variants={journeyItemVariants(index)}
              >
                <div
                  className={`md:w-1/2 ${
        ...
        >
          ...
          <p className="text-base text-gray-300 mb-6 max-w-xl mx-auto">
            ...
            interesting projects. Let&apos;s connect and bring your ideas to
            life!
          </p>

          <Link
            href="/contact"
            className="px-6 py-3 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full text-white font-medium hover:from-sky-600 hover:to-blue-700 transition-all duration-300 inline-flex items-center group"
          >
            Get in Touch
            <ArrowIcon />
          </Link>
