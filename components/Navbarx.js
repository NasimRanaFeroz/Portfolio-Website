...
const Navbarx = () => {
  ...
  return (
    <motion.div 
      className="navbar bg-[#0b1320] px-4 sm:px-10 lg:px-20 z-50"
    ...
    >
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <motion.ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-[#1B263B]/95 backdrop-blur-md rounded-box z-[1] mt-3 w-52 p-2 shadow text-white"
            initial="closed"
        ...
        >   
          <motion.p 
            className="text-white text-base sm:text-xl md:pl-3 sm:pl-2 lg:text-2xl font-bold"
            whileHover={{ scale: 1.05 }}
          >
            Nasim Rana Feroz
          </motion.p>
