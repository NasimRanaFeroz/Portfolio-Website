        ...
        >
          <nav className="flex bg-gray-800/70 border-b border-gray-700/50">
            <motion.button
              ...
              whileHover={{
                backgroundColor:
                  activeSection === "work" ? "#0b1727" : "#1f2937",
              }}
            >
              <div className="relative z-10 flex items-center space-x-3">
                <FaBriefcase
                  className={`text-xl ${
                    activeSection === "work" ? "text-blue-400" : "text-gray-400"
                  }`}
                />
            ...
            <motion.button
              ...
              whileHover={{
                backgroundColor:
                  activeSection === "education" ? "#0b1727" : "#1f2937",
              }}
            >
              <div className="relative z-10 flex items-center space-x-3">
                <FaGraduationCap
                  ...
                  <div className="space-y-12 relative">
                    {workExperience.map((job, index) => (
                      ...
                      >
                        ...
                        <motion.div
                          className={`ml-16 rounded-xl p-6 ${
                        ...
                        >
                          <div className="flex flex-col md:flex-row md:items-start gap-4">
                            ...
                            <div className="flex-grow">
                              ...
                              {index !== 0 &&
                                selectedItem !== `edu-${index}` && (
                                  <motion.button className="mt-3 text-xs text-indigo-400 hover:text-indigo-300 flex items-center">
                                    <span>Show details</span>
                                  </motion.button>
                                )}
                            </div>
